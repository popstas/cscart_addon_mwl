...
## Rules
- Create frontend templates at `var/themes_repository` instead of `design/themes`, it will be simlinked at test site.
...
# Cron tasks
Rules for backend cron modes: publish_down_missing_products_outdated, delete_unused_products, filters_sync, products_validate and other similar tasks:
