...
{capture name="mainbox"}
    <div class="mwl_xlsx-view-page">
        {if $products}
            ...
            <a class="mwl_google-export" target="_blank" href="{fn_url("mwl_xlsx.export_google?list_id=`$list.list_id`")}" title="{__("mwl_xlsx.export_google")}"><img src="{$images_dir}/addons/mwl_xlsx/gsheet.svg" alt="{__("mwl_xlsx.export_google")}" width="20" height="20" /> {__("mwl_xlsx.export_google")}</a>
            <br /><br />
