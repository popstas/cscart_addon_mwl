            ...
            {foreach $lists as $l}
                <tr data-ca-mwl-list-id="{$l.list_id}">
                    ...
                    <td class="">
                        ...
                        <a class="mwl_google-export" href="{fn_url("mwl_xlsx.export_google?list_id=`$l.list_id`")}" target="_blank" title="{__("mwl_xlsx.export_google")}"><img src="{$images_dir}/addons/mwl_xlsx/gsheet.svg" alt="{__("mwl_xlsx.export_google")}" width="20" height="20" /></a>
