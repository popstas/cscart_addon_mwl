...
Tygh.tr({
    ...
    "mwl_xlsx.max_list_items": {$addons.mwl_xlsx.max_list_items|default:0},
    "mwl_xlsx.planfix_create_task_url": '{"mwl_xlsx.planfix_create_task"|fn_url|escape:"javascript"}',
    "mwl_xlsx.planfix_enabled": 'Y',
